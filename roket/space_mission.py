...
LEVELS = [
    ...
    {"level": 6, "title": "ИНЖЕНЕРНОЕ ЧУДО",
     ...
     "task": "🔧 Инженер изобрёл гибрид велосипеда и автомобиля. Название состоит из первых 4 букв part1 = 'велосипед' и последних 7 букв part2 = 'автомобиль'. Выведи название этого чуда техники.",
     "hint": "print(part1[:4] + part2[-7:])", "unlock_code": ""},
